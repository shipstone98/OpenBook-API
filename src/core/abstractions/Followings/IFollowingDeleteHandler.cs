...
/// <summary>
/// Defines a method to unfollow a user.
/// </summary>
public interface IFollowingDeleteHandler
{
    /// <summary>
    /// Asynchronously unfollows the specified user for the current user.
    /// </summary>
    /// <param name="userName">The name of the user to unfollow.</param>
